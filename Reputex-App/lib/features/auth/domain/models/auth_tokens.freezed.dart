...
class _AuthTokens implements AuthTokens {
  const _AuthTokens({@JsonKey(name: 'access_token') required this.accessToken, @JsonKey(name: 'refresh_token') required this.refreshToken, @JsonKey(name: 'token_type') this.tokenType = 'bearer', @JsonKey(name: 'expires_in') this.expiresIn});
